...
data_path = 'C:/Users/patelm2017/PycharmProjects/cnn/data'
...
if model.predict_classes(test_image) == 0:
    print(model.predict_classes(test_image), '--> Cat')
elif model.predict_classes(test_image) == 1:
    print(model.predict_classes(test_image), '--> Dogs')
elif model.predict_classes(test_image)==2:
    print(model.predict_classes(test_image), '--> Horses')
elif model.predict_classes(test_image)==3:
    print(model.predict_classes(test_image), '--> Humans')


# Predicting images from the test dataset
test_data_path = 'C:/Users/patelm2017/PycharmProjects/cnn/data/dogs'
...
for test_image in test_img_list:
    ...
    if model.predict_classes(test_image) == 0:
        print(model.predict_classes(test_image), '--> Cats')
    elif model.predict_classes(test_image) == 1:
        print(model.predict_classes(test_image), '--> Dogs')
    elif model.predict_classes(test_image)==2:
        print(model.predict_classes(test_image), '--> Horses')
...
target_names = ['cats', 'dogs','horses','humans']
